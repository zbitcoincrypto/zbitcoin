...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Zbitcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
   {"clonecointools.com", "18.220.197.222"},
   {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Zbitcoin is probably already running."), addrBind.ToString().c_str());
        else
